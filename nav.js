...
(function() {
  ...
  + '    </div>'
  + '    <ul class="nav-menu">'
  + '      <li class="nav-menu-item"><a>Products <span class="arrow">&#9662;</span></a><div class="nav-dropdown"><a href="https://playbyplayu.com" target="_blank">PlayByPlay U</a><a href="index.html#playbyplayai">PlayByPlay AI</a></div></li>'
  + '      <li class="nav-menu-item"><a>Career <span class="arrow">&#9662;</span></a><div class="nav-dropdown"><a href="demo.html">Demo</a><a href="journey.html">Journey</a><a href="press.html">Press</a><a href="kudos.html">Kudos</a></div></li>'
  + '      <li class="nav-menu-item"><a>Misc <span class="arrow">&#9662;</span></a><div class="nav-dropdown"><a href="viral.html">Social Reel</a><a href="gamelog.html"><span id="gamesCount">Game Log</span></a></div></li>'
  + '      <li class="nav-menu-item no-drop"><a href="mailto:tony.castricone@learfield.com">Contact</a></li>'
  + '    </ul>'
  ...
  + '    <a href="https://playbyplayu.com" target="_blank" onclick="closeMobile()">PlayByPlay U</a>'
  + '    <a href="index.html#playbyplayai" onclick="closeMobile()">PlayByPlay AI</a>'
  + '    <div class="nav-mobile-group-label">Career</div>'
  + '    <a href="demo.html" onclick="closeMobile()">Demo</a>'
  ...
  + '    <div class="nav-mobile-group-label">Misc</div>'
  + '    <a href="viral.html" onclick="closeMobile()">Social Reel</a>'
  + '    <a href="gamelog.html" onclick="closeMobile()"><span id="gamesCountMobile">Game Log</span></a>'
  + '    <div class="nav-mobile-group-label">&nbsp;</div>'
  + '    <a href="mailto:tony.castricone@learfield.com" onclick="closeMobile()">Contact</a>'
  + '  </div>'
  + '</nav>';
